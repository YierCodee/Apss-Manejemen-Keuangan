...
import { Search, Settings, MessageSquare, Bell, Menu } from "lucide-react";
    ...
    <header className="h-16 border-b border-border bg-background flex items-center pl-4 pr-2 md:pl-6 md:pr-4">
      <div className="flex items-center w-full">
        ...
        <div className="flex items-center gap-2 md:gap-3 ml-auto">
          ...
          {/* Mobile search icon */}
          <button className="flex h-9 w-9 items-center justify-center rounded-lg border border-border hover:bg-accent transition-colors sm:hidden">
            <Search className="h-4 w-4 text-muted-foreground" />
          </button>
          <button className="hidden md:flex h-9 w-9 items-center justify-center rounded-lg border border-border hover:bg-accent transition-colors">
          ...
          <button className="relative flex h-9 w-9 items-center justify-center rounded-lg border border-border hover:bg-accent transition-colors">
            ...
            <span className="absolute -right-0.5 -top-0.5 h-2.5 w-2.5 rounded-full bg-red-500 border-2 border-background" />
          </button>
        </div>
      </div>
    </header>
